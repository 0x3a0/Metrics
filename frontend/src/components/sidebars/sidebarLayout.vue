...
<template>
  <div class="relative flex w-full h-svh bg-zinc-900/3">
    <!-- Sidebar container -->
    <aside class="fixed inset-y-0 left-0 w-64 flex flex-col">
      <!-- Sidebar header -->
      <div class="sticky top-0 shrink-0 px-4 py-3.5">   <!-- shrink-0 防止flex item缩小 -->
      ...
      <!-- Sidebar footer-->
      <div class="sticky bottom-0 shrink-0 px-4 py-3.5">
    ...
    <div class="flex-1 flex flex-col ml-64 pb-2 pt-2 pr-2">
      <div class="grow border border-zinc-950/10 bg-white rounded-lg shadow-xs px-9 py-8">
